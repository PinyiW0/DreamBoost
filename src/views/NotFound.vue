<template>
  <RouterLink to="/">
    <div class="bg-gray-800 py-25 py-md-28">
      <div class="container d-flex flex-column justify-contents-center bg-gray-800 py-15 py-md-30">
        <h1 class="text-gray-300 text-center mb-20">抱歉，您所搜尋的頁面不存在</h1>
        <div class="row">
              ...
              <g id="OBJECTS">
                  ...
                  <g id="Group_9">
                    ...
                    <g id="Group_11" opacity="0.25">
                      <g id="Group_12" opacity="0.25">
                        ...
                        <path id="Vector_60" opacity="0.25" d="M551.7 208.2L550.3 238" stroke="white" stroke-width="0.4635"
                          stroke-linecap="round" stroke-linejoin="round" stroke-dasharray="1.39 1.39" />
                    ...
                    <path id="Vector_62" opacity="0.25" d="M562 209.6L564.7 237.9" stroke="white" stroke-width="0.4635"
                      stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" stroke-dasharray="1.39 1.39" />
                ...
                <g id="Group_25">
                  <path id="Vector_124"
                    ...
                    fill="black" />
                  <path id="Vector_125"
                    d="M523.5 247.4C523.5 247.4 521.5 234.8 531.8 226.1C531.7 236.3 528.9 245 523.5 247.4Z" stroke="#1F3247"
                    stroke-width="0.9271" stroke-miterlimit="10" />
                  <g id="Group_26">
                    <path id="Vector_126"
                ...
                <g id="Group_32">
                  <path id="Vector_138"
                    ...
                    fill="black" />
                  <path id="Vector_139"
                    d="M174.2 250.2C174.2 250.2 161.8 247.6 154.1 238.3C167.3 239.7 173 244.4 174.2 250.2Z" stroke="#1F3247"
                    stroke-width="0.9271" stroke-miterlimit="10" />
                  <g id="Group_33">
                    <path id="Vector_140"
