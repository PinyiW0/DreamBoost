<template>
  ...
  <section class="container py-16">
    <div class="row gy-4">
      <div class="col-md-7">
        <div class="position-relative mb-7 p-6 border border-2 border-primary rounded-3 shadow">
        ...
        <div class="p-6 border border-gray-400">
          {{ productList }}
          <div v-html="proposalArticle" class="ck-content">
          </div>
        </div>
      </div>
      <div class="col-md-5">
        <div class="mb-7 p-4 p-lg-12 pe-lg-23 border border-2 border-primary rounded-3">
          <div class="d-flex align-items-center gap-6 mb-9">
            <div class="d-flex justify-content-center align-items-center bg-primary rounded-circle"
              ...
              <img class="img-fluid object-fit-cover" src="/images/home/icon112.svg" alt="" />
            </div>
