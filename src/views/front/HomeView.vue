      ...
      <div class="container d-flex flex-column justify-content-center">
        <div class="row g-10 mb-7 pb-27">
          <div class="col-12 col-sm-6 col-lg-2 g-4 g-sm-3 g-md-2">
            <div class="position-relative rounded-3 csImage rounded-3 overflow-hidden">
              <router-link :to="{ name: 'explore'}" class="position-relative">
                ...
                <img src="/images/home/cs_01.png" alt="專案推播圖" loading="lazy" class="img-fluid object-fit-cover h-100 col-12">
              </router-link>
            </div>
          </div>
          <div class="col-12 col-sm-6 col-lg-2 g-4 g-sm-3 g-md-2">
            <div class="position-relative rounded-3 csImage rounded-3 overflow-hidden">
              <router-link :to="{ name: 'explore' }" class="position-relative">
                <h4 class="project-name1 text-center text-white mx-auto z-2 lterSpc-5">查看更多</h4>
                <img src="/images/home/cs_02.png" alt="專案推播圖" loading="lazy" class="img-fluid object-fit-cover h-100 col-12 rounded-3">
              </router-link>
            </div>
          </div>
          <div class="col-12 col-sm-6 col-lg-4 g-4 g-sm-3 g-md-2">
            <div class="position-relative rounded-3 csImage rounded-3 overflow-hidden">
              <router-link :to="{ name: 'explore' }" class="position-relative">
                ...
                <img src="/images/home/cs_03.png" alt="專案推播圖" loading="lazy" class="img-fluid object-fit-cover h-100 col-12 rounded-3">
              </router-link>
            </div>
          </div>
          <div class="col-12 col-sm-6 col-lg-4 g-4 g-sm-3 g-md-2">
            <div class="position-relative rounded-3 csImage rounded-3 overflow-hidden">
              <router-link :to="{ name: 'explore' }" class="position-relative">
                <h4 class="project-name2 text-center text-white mx-auto z-2 lterSpc-5">查看更多</h4>
                <img src="/images/home/cs_04.jpg" alt="專案推播圖" loading="lazy" class="img-fluid object-fit-cover h-100 col-12 rounded-3">
              </router-link>
            </div>
          </div>
          <div class="col-12 col-sm-6 col-lg-4 g-4 g-sm-3 g-md-2">
            <div class="position-relative rounded-3 h-100 csImage rounded-3 overflow-hidden">
              <router-link :to="{ name: 'explore' }" class="position-relative">
                <h4 class="project-name2 text-center text-white mx-auto z-2 lterSpc-5">查看更多</h4>
                <img src="/images/home/cs_05.jpg" alt="專案推播圖" loading="lazy" class="img-fluid object-fit-cover h-100 col-12 rounded-3">
              </router-link>
            </div>
          </div>
          <div class="col-12 col-sm-6 col-lg-4 g-4 g-sm-3 g-md-2">
            <div class="position-relative rounded-3 csImage rounded-3 overflow-hidden">
              <router-link :to="{ name: 'explore' }" class="position-relative">
                <h4 class="project-name2 text-center text-white mx-auto z-2 lterSpc-5">查看更多</h4>
                <img src="/images/home/cs_06.png" alt="專案推播圖" loading="lazy" class="img-fluid object-fit-cover h-100 col-12 rounded-3">
              </router-link>
            </div>
          </div>
          <div class="col-12 col-sm-6 col-lg-2 g-4 g-sm-3 g-md-2">
            <div class="position-relative rounded-3 csImage rounded-3 overflow-hidden">
              <router-link :to="{ name: 'explore' }" class="position-relative">
                <h4 class="project-name1 text-center text-white mx-auto z-2 lterSpc-5">查看更多</h4>
                <img src="/images/home/cs_07.png" alt="專案推播圖" loading="lazy" class="img-fluid object-fit-cover h-100 col-12 rounded-3">
              </router-link>
            </div>
          </div>
          <div class="col-12 col-sm-6 col-lg-2 g-4 g-sm-3 g-md-2">
            <div class="position-relative rounded-3 csImage rounded-3 overflow-hidden">
              <router-link :to="{ name: 'explore' }" class="position-relative">
                <h4 class="project-name1 text-center text-white mx-auto z-2 lterSpc-5">查看更多</h4>
                <img src="/images/home/cs_08.png" alt="專案推播圖" loading="lazy" class="img-fluid object-fit-cover h-100 col-12 rounded-3">
              </router-link>
            </div>
          </div>
        </div>
