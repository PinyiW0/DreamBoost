          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="d-flex gap-2">
                <select id="identity" class="form-select w-50 w-md-25">
        ...
        <div class="col-12 mt-17">
          <div class="row justify-content-between">
            <div class="col-md-3">
              <button
                type="button"
                class="btn btn-gray-400 px-7 w-100 mb-4 mb-md-0"
              >
                刪除專案
              </button>
            </div>
            <div class="col-md-8 col-lg-6 d-flex justify-content-end flex-wrap">
              <button
                type="button"
                class="btn btn-primary-light px-17 mb-4 mb-md-0 me-md-6 w-100 w-md-auto"
              >
                預覽專案
              </button>
              <button
