  ...
  <main>
    ...
    <section class="container mb6">
      <div class="bg-bgc-paper d-flex align-items-center justify-content-center mt-8">
        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-info-circle text-primary me-2" viewBox="0 0 16 16">
    ...
    <section>
      ...
      >
        <swiper-slide class="pt-10 mb-6 d-flex">
          <PlanCard class="col"></PlanCard>
        </swiper-slide>
        <swiper-slide class="pt-10 mb-6">
          <PlanCard class="col"></PlanCard>
        </swiper-slide>
        <swiper-slide class="pt-10 mb-6">
          <PlanCard class="col"></PlanCard>
