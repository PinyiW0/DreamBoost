    ...
    <ul class="row row-cols-1 row-cols-md-3 g-xl-14 list-unstyled">
      <li class="col">
        <div class="card border-0">
          ...
          <div class="card-body p-6">
            <h5 class="card-title text-primary fs-4 text-center">原創型專案</h5>
      ...
      <li class="col">
        <div class="card border-0">
          ...
          />
          <div class="card-body p-6">
            <h5 class="card-title text-primary fs-4 text-center">倡議型專案</h5>
            <p class="card-text mx-auto w-100 w-xl-75">
      ...
      <li class="col">
        <div class="card border-0">
          ...
          />
          <div class="card-body p-6">
            <h5 class="card-title text-primary fs-4 text-center">預購型專案</h5>
            <p class="card-text mx-auto w-100 w-xl-75">
  ...
  <section class="container pb-25" id="last">
    ...
    <div class="row align-items-center">
      <div class="col-lg-6 order-last order-lg-first">
          ...
          <li class="d-flex align-items-center gap-2 mb-9">
            ...
            <div>
              <p class="mb-0 text-gray-700 fs-18">
                您已滿 18 歲是具備完全行為能力的自然人，或是合法登記的法人或團體
              </p>
        ...
        <div class="d-flex align-items-center gap-2 mb-13">
          <input
            type="checkbox"
            id="check"
          ...
          />
          <label for="check" class="fs-18"
            >您已符合以上敘述並同意 DreamBoost
            <a href="#" class="text-decoration-underline">網站使用條款</a> 及
