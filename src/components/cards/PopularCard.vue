<template>
  ...
  <img :src="popularProjects?.proposalMainImage" class="imgcover img-fluid rounded-3 mb-7 col-12 h-100" style="" alt="">
  ...
  <div class="progress bg-secondary-light mb-7" style="height: 10px;">
    <div class="progress-bar bg-primary-dark rounded-pill" role="progressbar" :style="{ width: randomValue + 70 + '%'}"
      aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
  </div>
  <div class="d-flex align-items-center justify-content-between">
    <div class="d-flex align-items-center">
      <img :src="popularProjects?.customizeProperty?.userImage" class="img-fluid me-6 rounded-5"
